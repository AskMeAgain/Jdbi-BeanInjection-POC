...
import io.github.askmeagain.jdbiplugin.customizer.UpdateAllSqlStatementCustomizer;
...
@SqlStatementCustomizingAnnotation(UpdateAllSqlStatementCustomizer.class)
